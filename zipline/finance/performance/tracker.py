...
class PerformanceTracker(object):
    ...
    def __init__(self, sim_params, env=None):
        ...
        self.market_open, self.market_close = \
            env.get_open_and_close(self.day)
        ...
        self._asset_ends = {}
        self._past_asset_end_dates = set()
    ...
    def _update_asset(self, sid, env=None):
        ...
        if asset.end_date:
            try:
                ...
                date_sids = [asset.sid]
                self._asset_ends[asset.end_date] = date_sids
    ...
    def close_expired_asset_positions(self, next_trading_day):
        """
        ...
        position_tracker.
        """
        for date, sids in self._asset_ends.items():
